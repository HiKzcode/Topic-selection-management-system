  ...
  <div class="container1">
       <form action="">
            <div class="title">
             ...
             <div class="item">
               <label> 密码：  </label>
               <input type="password" v-model="password" :disabled="isActive">
             </div>    
             <div class="item">
               <label>详情： </label>
 ...
 export default{
  ...
  data(){
     ...
     return{ 
        ...
        userName:'张三',
        password:'1',
        description:'wrdqfcsGACOIUgAiucfavuyGASUcuyoagvjhdsbvbzmvbksbdvdsvsdfvdsvdsvEvVB的撒B的FV爱和法尔ui符合随后vu额户口'
      ...
      this.$axios({
          ...
          headers:{
            ...
            console.log(res)
               ...
               this.userame=res.data.data.name
               this.=res.data.data.gender
