      ...
      <template v-slot:aside>
        <el-aside width="200px">
          ...
          <el-menu class="custom-menu" @select="handleMenuSelect">
            ...
            <el-menu-item index="2" :class="{ 'active': selectedMenu === '2' }">
              <i class="el-icon-view"></i>查看考勤
            </el-menu-item>
            <el-menu-item index="3" :class="{ 'active': selectedMenu === '3' }">
              <i class="el-icon-user-solid"></i>个人中心
            </el-menu-item>
            <el-menu-item index="4" :class="{ 'active': selectedMenu === '4' }">
