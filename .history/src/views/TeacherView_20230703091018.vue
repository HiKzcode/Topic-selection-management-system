      ...
      <template v-slot:aside>
        <el-aside width="200px">
          ...
          <el-menu class="custom-menu"  @select="handleMenuSelect">
           ...
           <el-menu-item index="4" :class="{ 'active': selectedMenu === '4' }"><i class="el-icon-circle-close"></i>退出登录</el-menu-item>
          </el-menu>
        </el-aside>
      </template>
        ...
        <el-main>
          ...
          <div v-if="selectedMenu === '1'">
            ...
            <div class="cs">
              ...
              <template>
               <div>
                <SearchComponent @search="handleSearch"  :questions="questions"></SearchComponent>
              </div>
             </template>
                <!-- 创建题目的弹窗 -->
            ...
            <span slot="footer" class="dialog-footer">
             ...
             <el-button type="primary" @click="handleDialogConfirm">确认</el-button>
              ...
              <div v-else>
               ...
               <Cquestion :questionName="question.questionName" :questionId="question.questionId" @questionDeleted="deleteQuestion(index)"></Cquestion>
              </div>
            </div>       
          </div>
