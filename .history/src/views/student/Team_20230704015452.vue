      ...
      <!-- 在这里放置创建队伍选题的相关内容 -->
       ...
       <el-form-item size="large">
        ...
        <el-table-column label="组队">
            ...
            <el-button round @click="downloadFile">下载文件</el-button>
        </el-table-column>
      </el-table>
		  	<p v-else>你还未组队</p>
		</div>
      ...
      <el-row>
        <el-col :span="24">
          ...
          <ul style="list-style-type: none;">
            <li style="height: 50px;" v-for="file in fileList" :key="file">{{ file }}</li>
          </ul>
         </el-col>
      </el-row>
    </el-drawer>
		<el-dialog  :visible.sync="showSuccessDialog title="请输入文件名" width="30%">
     <span slot="body">
