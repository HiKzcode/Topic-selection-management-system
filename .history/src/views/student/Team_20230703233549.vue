      ...
      <!-- 在这里放置创建队伍选题的相关内容 -->
        <div class="createc">
					<div class="create-box" >	
						...
						<el-form ref="form" :model="cForm" label-width="80px" size="mini" style="width: 397px; background-color: aliceblue; border-color:aliceblue ;">
             <el-form-item label="团队名称" style="width: 300px; height: 70px;">
             <el-input v-model="cForm.name" style="height:100px"></el-input>
            </el-form-item>
            <el-form-item label="题目选择" style="height: 70px;">
           <el-select v-model="cForm.region" placeholder="请选择题目"  style="margin-right: 400px;width: 220px; ">
