<template>
  <div>
    ...
    <div v-else-if="currentView === 'createTeam'">
     ...
     <el-select v-model="selectedQuestion" placeholder="请选择题目" @remote="getquestionlist" @change="updateTeamInfo" style="margin-right: 400px; width: 220px;">
        <el-option
          v-for="question in questionlist"
          :key="question.questionId"
          :label="selectedQuestion.questionName"
          :value="question"
       ></el-option>
    </el-select>
		{{ selectedQuestion }}
