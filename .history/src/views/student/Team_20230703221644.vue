    ...
    <div v-else-if="currentView === 'createTeam'">
      <!-- 在这里放置创建队伍选题的相关内容 -->
        <div class="createc">
             ...
             <el-form-item v-model="sizeForm.name" label="团队名称:" prop="teamName" style="height: 70px;">
              <el-input style="width: 200px; margin-right: 400px;"></el-input>
             </el-form-item>
             <el-form-item v-model="sizeForm.region" label="题目名称" prop="questionName" style="height: 70px;">
