      ...
      <!-- 在这里放置创建队伍选题的相关内容 -->
        <div class="createc">
					<div class="create-box" >	
						...
						<el-form  label-width="80px" class="demo-ruleForm" style="width: 397px; background-color: aliceblue; border-color:aliceblue ;">
             <el-form-item label="团队名称:" prop="teamName" style="height: 70px;">
