      ...
      <!-- 在这里放置创建队伍选题的相关内容 -->
        <div class="createc">
					<div class="create-box" >	
						...
						<!--<el-form ref="form" :model="sizeForm"  label-width="80px" style="width: 397px; background-color: aliceblue; border-color:aliceblue ;">
             <el-form-item v-model="sizeForm.teamName" label="团队名称:" prop="teamName" style="height: 70px;">
              <el-input style="width: 200px; margin-right: 400px;"></el-input>
             </el-form-item>
             <el-form-item v-model="sizeForm.questionName" label="题目名称" prop="questionName" style="height: 70px;">
                8<el-select placeholder="请选择题目" style="margin-right: 400px;width: 200px;" >
                <el-option label="题目一"></el-option>
                <el-option label="题目二"></el-option>
               </el-select>
            </el-form-item>
						<el-form-item >
						...
						<el-form ref="form" :model="sizeForm" label-width="80px" size="mini" style="width: 397px; background-color: aliceblue; border-color:aliceblue ;">
             <el-form-item label="团队名称" style="width: 300px; height: 70px;">
             <el-input v-model="sizeForm.name"></el-input>
            </el-form-item>
            <el-form-item label="题目选择"style="width: 300px; height: 70px;">
           <el-select v-model="sizeForm.region" placeholder="请选择题目"  style="margin-right: 400px;width: 220px; ">
           <el-option label="题目一" value="shanghai"></el-option>
          <el-option label="题目二" value="beijing"></el-option>
         </el-select>
        </el-form-item>
