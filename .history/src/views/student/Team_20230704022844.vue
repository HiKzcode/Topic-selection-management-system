        ...
        <el-col :span="24">
          ...
          <ul style="list-style-type: none;">
            <li style="height: 50px;" v-for="file in fileList" :key="file">
							...
							{{ file }}
						 	<!--
								<el-button type="danger" icon="el-icon-delete" circle size="mini"  style="width: 25px; height: 25px;" @click="deleteFile(file)"></el-button>
								-->
								<el-button style="margin-right: 80px;" type="danger" @click="deleteFile(file)" round>危险按钮</el-button>
							</li>
          </ul>
         </el-col>
      </el-row>
