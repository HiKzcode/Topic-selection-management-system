<template>
  <div>
    ...
    <div v-else-if="currentView === 'createTeam'">
     ...
     <el-select v-model="selectedQuestion" placeholder="请选择题目" @remote="getquestionlist" style="margin-right: 400px; width: 220px;">
        <el-option
       ...
       ></el-option>
        ...
        <el-input v-model="selectedQuestion.questionName" readonly></el-input>
      </el-form-item>
      <el-form-item label="题目ID">
        <el-input v-model="selectedQuestion.questionId" readonly></el-input>
      </el-form-item>
</el-form-item>
  ...
  methods: {
    ...
    uploadFile() {
      ...
      if (this.selectedQuestion) {
        ...
        this.cForm.teamId = this.selectedQuestion.teamId;
      } else {
