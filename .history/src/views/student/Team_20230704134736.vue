      ...
      <!-- 在这里放置创建队伍选题的相关内容 -->
       ...
       <el-form-item size="large">
		...
		<div v-else-if="currentView === 'showTeam'">
		   我的团队
			 {{ myteam }}
			 <el-table v-if="myteam.length != ''" :data="myteam" style="width: 100%" row-height="60px">
        <el-table-column prop="this.myteam.teamName" label="队伍名称" style="height: 50px;"></el-table-column>
        <el-table-column prop="this.myteam.questionName" label="选题名称" class="custom-column"></el-table-column>
        <el-table-column label="组队">
